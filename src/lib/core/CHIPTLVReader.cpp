...
/**
 * Get the destination reader with the given tag
 *
 ...
 */
CHIP_ERROR TLVReader::FindElementWithTag(const uint64_t tagInApiForm, TLVReader & destReader) const
{
    CHIP_ERROR err = CHIP_NO_ERROR;
