 ...
 */
#define CHIP_ERROR_INTERMEDIATE_CA_NOT_REQUIRED                      _CHIP_ERROR(191)


#define CHIP_ERROR_CLUSTER_NOT_FOUND                            _CHIP_ERROR(192)

#define CHIP_ERROR_STATUS_RESPONSE_RECEIVED                     _CHIP_ERROR(193)
