...
CHIP_ERROR StatusCode::Parser::GetClusterId(chip::ClusterId * apClusterId) const
{
...
StatusCode::Builder & StatusCode::Builder::ClusterId(const chip::ClusterId aClusterId)
{
    SuccessOrExit(mError);
    mError = mpWriter->Put(chip::TLV::ContextTag(kCsTag_ClusterId), aClusterId);
